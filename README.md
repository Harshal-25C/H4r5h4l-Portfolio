...
This repository powers the personal portfolio of **Harshal Choudhary**, an aspiring Software Engineer and B.Tech CSE graduate. — a single-page React application designed to feel *cinematic*: soft gold-and-violet gradients, glass-panel cardshklv, animated conic-gradient borders, floating shapes, and scroll-triggered motion, all wrapped around a clean, professional narrative of who Harshal is as an engineer.
